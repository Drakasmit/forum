...
return array(
	...
	'forum_create_title' => 'Название категории',
	...
	'forum_create_title_error' => 'Название форума должно быть от 3 до 100 символов',
	'forum_create_url' => 'URL форума',
	'forum_create_url_note' => 'Короткий адресс, по которому будет доступен форум (Необязательное поле)',
	'forum_create_url_error' => 'URL форума должен быть от 3 до 50 символов и только на латинице + цифры и знаки "-", "_"',
	...
	'forum_delete_ok' => 'Форум и все его содержимое успешно удалено',
